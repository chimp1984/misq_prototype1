package misq.p2p.sim;/* A variable length array of bytes with convenient methods for sequentially/randomly reading/writing primitive types and other streams to files and sockets.
